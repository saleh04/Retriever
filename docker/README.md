# Docker Setup for Retriever Application

This directory contains the Docker setup for the Retriever application, including all necessary services for development and monitoring.
